...
@inject('category', '\App\Domains\Cluster3\Models\ChildNutrition\ChildNutritionRecapitulationCategory')

@section('title', __('Buat Rekapitulasi Status Gizi Anak'))

<x-forms.post wire:submit.prevent="submit">
    <x-backend.card>
        <x-slot name="header">
            @lang('Buat Rekapitulasi Status Gizi Anak')
        </x-slot>
