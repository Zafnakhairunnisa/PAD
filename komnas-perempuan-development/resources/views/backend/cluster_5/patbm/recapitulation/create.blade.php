@section('title', __('Buat Recapitulasi Perlindungan Anak Terpadu Berbasis Masyarakat (PATBM)'))

<x-forms.post wire:submit.prevent="submit">
    <x-backend.card>
        <x-slot name="header">
            @lang('Buat Recapitulasi Perlindungan Anak Terpadu Berbasis Masyarakat (PATBM)')
        </x-slot>
