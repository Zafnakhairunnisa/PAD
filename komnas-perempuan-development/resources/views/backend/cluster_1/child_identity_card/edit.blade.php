...
@section('title', __('Ubah Kepemilikan Kartu Identitas Anak (KIA)'))

<x-forms.patch wire:submit.prevent="submit">
    <x-backend.card>
        <x-slot name="header">
            @lang('Ubah Kepemilikan Kartu Identitas Anak (KIA)')
        </x-slot>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    ...
                    >
                        ...
                        @foreach (config('constants.child_identity_card_category') as $category)
