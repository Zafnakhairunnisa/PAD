...
@section('content')
    <x-forms.patch
        ...
        :action="route('admin.institutional.satgas_ppa.update', $satgas)"
    >
        <x-backend.card>
            <x-slot name="header">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('kelurahan', $satgas->kelurahan) }}"
                        />
                        @error('kelurahan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('kemantren', $satgas->kemantren) }}"
                        />
                        @error('kemantren')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('kabupaten', $satgas->kabupaten) }}"
                        />
                        @error('kabupaten')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
