...
@section('title', __('Buat Rekapitulasi Satgas PPA'))

@section('content')

    <x-forms.post :action="route('admin.institutional.satgas_ppa.recapitulation.store')">
        <x-backend.card>
            <x-slot name="header">
                @lang('Buat Rekapitulasi Satgas PPA')
            </x-slot>
