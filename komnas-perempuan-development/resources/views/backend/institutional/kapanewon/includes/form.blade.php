...
<div class="form-group row">
    <label
        for="kapanewon_kemantren"
        class="col-md-2 col-form-label"
    >@lang('Kapanewon / Kemantren')</label>

    <div class="col-md-10">
        <select
            wire:model.defer="kapanewon_kemantren"
            class="form-control @error('kapanewon_kemantren') is-invalid @enderror"
        >
            <option
                hidden
                value=''
            >{{ __('Pilih Kapanewon / Kemantren') }}</option>
            @foreach (config('constants.kapanewon.kapanewon_kemantren') as $value)
                <option
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        ...
        >
            ...
            @foreach (config('constants.kapanewon.kabupaten') as $value)
                <option
                    @if ($value === old('value')) selected @endif
                    value="{{ $value }}"
                >@lang($value)</option>
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        ...
        >
            ...
            @foreach (config('constants.kapanewon.profil_anak') as $value)
                <option
                    @if ($value === old('value')) selected @endif
                    value="{{ $value }}"
                >@lang($value)</option>
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        ...
        >
            ...
            @foreach (config('constants.kapanewon.forum_anak') as $value)
                <option
                    @if ($value === old('value')) selected @endif
                    value="{{ $value }}"
                >@lang($value)</option>
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        ...
        >
            ...
            @foreach (config('constants.kapanewon.ruang_bermain') as $value)
                <option
                    @if ($value === old('value')) selected @endif
                    value="{{ $value }}"
                >@lang($value)</option>
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        ...
        >
            ...
            @foreach (config('constants.kapanewon.pusat_informasi') as $value)
                <option
                    @if ($value === old('value')) selected @endif
                    value="{{ $value }}"
                >@lang($value)</option>
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        ...
        >
            ...
            @foreach (config('constants.kapanewon.pusat_kreatifitas') as $value)
                <option
                    @if ($value === old('value')) selected @endif
                    value="{{ $value }}"
                >@lang($value)</option>
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        ...
        >
            ...
            @foreach (config('constants.kapanewon.satgas_ppa') as $value)
                <option
                    @if ($value === old('value')) selected @endif
                    value="{{ $value }}"
                >@lang($value)</option>
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        ...
        >
            ...
            @foreach (config('constants.kapanewon.patbm') as $value)
                <option
                    @if ($value === old('value')) selected @endif
                    value="{{ $value }}"
                >@lang($value)</option>
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        ...
        >
            ...
            @foreach (config('constants.kapanewon.pikr') as $value)
                <option
                    @if ($value === old('value')) selected @endif
                    value="{{ $value }}"
                >@lang($value)</option>
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        ...
        >
            ...
            @foreach (config('constants.kapanewon.kawasan_tanpa_rokok') as $value)
                <option
                    @if ($value === old('value')) selected @endif
                    value="{{ $value }}"
                >@lang($value)</option>
