...
@section('content')
    <x-forms.patch
        ...
        :action="route('admin.institutional.child_media.update', $data)"
    >
        <x-backend.card>
            <x-slot name="header">
                    ...
                    <div class="col-md-10">
                        ...
                        >
                            ...
                            @foreach ($media->get() as $media)
                                <option
                                    @if ($media->id === old('jenis_media_id', $data->jenis_media_id)) selected @endif
                                    value="{{ $media->id }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('kalurahan', $data->kalurahan) }}"
                        />
                        @error('kalurahan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('kapanewon', $data->kapanewon) }}"
                        />
                        @error('kapanewon')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('nama_pimpinan', $data->nama_pimpinan) }}"
                        />
                        @error('nama_pimpinan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
