...
@section('title', __('Buat Rekapitulasi Media Massa Sahabat Anak'))

@section('content')

    <x-forms.post :action="route('admin.institutional.child_media.recapitulation.store')">
        <x-backend.card>
            <x-slot name="header">
                @lang('Buat Rekapitulasi Media Massa Sahabat Anak')
            </x-slot>
