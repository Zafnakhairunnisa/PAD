...
@section('title', __('Ubah Rekapitulasi Kegiatan Perlindungan Anak'))

@section('content')
    <x-forms.patch :action="route('admin.institutional.child_protection_activity.recapitulation.update', $recapitulation)">
        <x-backend.card>
            <x-slot name="header">
                @lang('Ubah Rekapitulasi Kegiatan Perlindungan Anak')
            </x-slot>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('company_count', $recapitulation->company_count) }}"
                        />
                        @error('company_count')
                    ...
                    <div class="col-md-10">
                        <div class="input-group">
                            ...
                            <input
                                ...
                                value="{{ old('source_of_fund_apbd', $recapitulation->source_of_fund_apbd) }}"
                            />
                        </div>
                    ...
                    <div class="col-md-10">
                        <div class="input-group">
                            ...
                            <input
                                ...
                                value="{{ old('source_of_fund_csr', $recapitulation->source_of_fund_csr) }}"
                            />
                        </div>
                    ...
                    <div class="col-md-10">
                        ...
                        >
                            ...
                            <input
                                ...
                                value="{{ old('budget_amount', $recapitulation->budget_amount) }}"
                            />
                        </div>
                        @error('budget_amount')
                            <div class="invalid-feedback">{{ $message }}</div>
