...
@section('title', __('Buat Rekapitulasi Forum Anak'))

@section('content')

    <x-forms.post :action="route('admin.institutional.child_forum.recapitulation.store')">
        <x-backend.card>
            <x-slot name="header">
                @lang('Buat Rekapitulasi Forum Anak')
            </x-slot>
