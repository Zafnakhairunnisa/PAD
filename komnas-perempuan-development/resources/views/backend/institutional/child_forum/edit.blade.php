...
@section('content')
    <x-forms.patch
        ...
        :action="route('admin.institutional.child_forum.update', $childForum)"
    >
        <x-backend.card>
            <x-slot name="header">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('nama', $childForum->nama) }}"
                        />
                        @error('nama')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        ...
                        >
                            ...
                            <option
                                value="provinsi"
                                {{ oldSelected('tingkat', 'provinsi', $childForum->tingkat) }}
                            >@lang('Provinsi')</option>
                            <option
                                value="kabupaten"
                                {{ oldSelected('tingkat', 'kabupaten', $childForum->tingkat) }}
                            >@lang('Kabupaten / Kota')</option>
                            <option
                                value="kapanewon"
                                {{ oldSelected('tingkat', 'kapanewon', $childForum->tingkat) }}
                            >@lang('Kapanewon / Kemantren')</option>
                            <option
                                value="kalurahan"
                                {{ oldSelected('tingkat', 'kalurahan', $childForum->tingkat) }}
                            >@lang('Kalurahan / Kelurahan')</option>
                            <option
                                value="dusun"
                                {{ oldSelected('tingkat', 'dusun', $childForum->tingkat) }}
                            >@lang('Dusun')</option>
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('surat_keputusan', $childForum->surat_keputusan) }}"
                        />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('waktu_pembentukan', $childForum->waktu_pembentukan) }}"
                        />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('nama_ketua', $childForum->nama_ketua) }}"
                        />
                        @error('nama_ketua')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('nomor_telepon', $childForum->nomor_telepon) }}"
                        />
                        @error('nomor_telepon')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('alamat', $childForum->alamat) }}"
                        />
                        @error('alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('kalurahan', $childForum->kalurahan) }}"
                        />
                        @error('kalurahan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('kapanewon', $childForum->kapanewon) }}"
                        />
                        @error('kapanewon')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('kabupaten', $childForum->kabupaten) }}"
                        />
                        @error('kabupaten')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('media_sosial', $childForum->media_sosial) }}"
                        />
                        @error('media_sosial')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        ...
                        >
                            ...
                            <option
                                value="sudah"
                                {{ oldSelected('pelatihan_kha', 'sudah', $childForum->pelatihan_kha) }}
                            >@lang('Sudah')</option>
                            <option
                                value="belum"
                                {{ oldSelected('pelatihan_kha', 'belum', $childForum->pelatihan_kha) }}
                            >@lang('Belum')</option>
                        </select>
                        @error('pelatihan_kha')
                            <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        ...
                        >
                            ...
                            <option
                                value="sudah"
                                {{ oldSelected('partisipasi_musrenbang', 'sudah', $childForum->partisipasi_musrenbang) }}
                            >@lang('Sudah')</option>
                            <option
                                value="belum"
                                {{ oldSelected('partisipasi_musrenbang', 'belum', $childForum->partisipasi_musrenbang) }}
                            >@lang('Belum')</option>
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('kegiatan', $childForum->kegiatan) }}"
                        />
                        @error('kegiatan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ old('prestasi', $childForum->prestasi) }}"
                        />
                        @error('prestasi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
