...
@section('title', __('Ubah Rekapitulasi Organisasi Peduli Anak'))

@section('content')
    <x-forms.patch :action="route('admin.institutional.child_care_organization.recapitulation.update', $data)">
        <x-backend.card>
            <x-slot name="header">
                @lang('Ubah Rekapitulasi Organisasi Peduli Anak')
            </x-slot>
