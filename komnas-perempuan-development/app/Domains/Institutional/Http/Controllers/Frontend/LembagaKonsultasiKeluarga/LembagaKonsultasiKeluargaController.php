...
namespace App\Domains\Institutional\Http\Controllers\Frontend\LembagaKonsultasiKeluarga;
...
/**
 * Class LembagaKonsultasiKeluargaController.
 */
class LembagaKonsultasiKeluargaController
{
    ...
    /**
     * @var FamilyConsultancyService
     */
    private $service;

    /**
     * @var FamilyConsultancyRecapitulationService
     */
    ...
    public function __construct(
        FamilyConsultancyService $service,
        FamilyConsultancyRecapitulationService $recapitulationService
        ) {
        $this->service = $service;
        $this->recapitulationService = $recapitulationService;
        $this->categories = collect(config('constants.family_consultancy.recapitulation_category'));
    }
    ...
    {
        return inertia('Cluster2/LembagaKonsultasiKeluarga', [
            'recapitulation' => [
    ...
    private function generate_recapitulation_column()
    {
        ...
        $columns = $yearRanges->map(function ($year, $yearIndex) {
            return [
                ...
                'children' => [
                    [
                        'title' => 'Jumlah Lembaga Konsultasi',
                        'align' => 'right',
    ...
    private function generate_list_data()
    {
        ...
        $listData = $this->service->api()
            ...
            ->allowedSorts([
                ...$select,
                AllowedSort::field('category', 'kategori_id'),
    ...
    private function generate_list_column()
    {
        $columns = [
            ...
            [
                'title' => 'Nomor Sertifikasi',
                'align' => 'center',
                'dataIndex' => 'no_sertifikasi',
                'sorter' => true,
            ],
            [
                'title' => 'Kegiatan',
    ...
    {
        $locations = $this->get_locations();
        $recapitulationCategories = collect([
            [
                'name' => 'Lembaga Konsultasi',
            ],
            [
                'name' => 'Klien',
            ]
