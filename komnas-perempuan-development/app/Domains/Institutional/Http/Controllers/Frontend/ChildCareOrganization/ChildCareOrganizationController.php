...
namespace App\Domains\Institutional\Http\Controllers\Frontend\ChildCareOrganization;
...
class ChildCareOrganizationController
{
    ...
    public function __construct(
        ChildCareOrganizationService $service,
        ChildCareOrganizationRecapitulationService $recapitulationService
    ) {
    ...
    {
        return inertia('Institutional/ChildCareOrganization', [
            'recapitulation' => [
