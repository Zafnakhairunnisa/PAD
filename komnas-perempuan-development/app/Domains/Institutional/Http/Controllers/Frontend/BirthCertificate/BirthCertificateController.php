...
namespace App\Domains\Institutional\Http\Controllers\Frontend\BirthCertificate;
...
class BirthCertificateController
{
    ...
    public function __construct(
        BirthCertificateService $service
    ) {
    ...
    {
        return inertia('Cluster1/BirthCertificate', [
            'recapitulation' => [
