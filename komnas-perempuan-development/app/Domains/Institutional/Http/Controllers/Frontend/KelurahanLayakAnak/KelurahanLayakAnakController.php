...
namespace App\Domains\Institutional\Http\Controllers\Frontend\KelurahanLayakAnak;
...
/**
 * Class KelurahanLayakAnakController.
 */
class KelurahanLayakAnakController
{
    use LocationTrait;
    ...
    /**
     * @var KelurahanRecapitulationService
     */
    ...
    public function __construct(
        KelurahanRecapitulationService $recapService,
        KelurahanService $service
    ) {
        $this->service = $service;
        $this->recapService = $recapService;
        $this->categories = KelurahanRecapitulationCategory::all();
    }
    ...
    {
        return inertia('Institutional/KelurahanLayakAnak', [
            'recapitulation' => [
