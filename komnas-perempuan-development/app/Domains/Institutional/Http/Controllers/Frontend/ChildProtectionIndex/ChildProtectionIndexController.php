...
namespace App\Domains\Institutional\Http\Controllers\Frontend\ChildProtectionIndex;
...
class ChildProtectionIndexController
{
    ...
    public function __construct(
        ChildProtectionIndexService $childProtectionIndexService,
        ) {
        $this->recapitulationService = $childProtectionIndexService;
        $this->categories = collect(config('constants.child_protection_indices_category'));
    }
    ...
    {
        return inertia('Institutional/ChildProtectionIndex', [
            'recapitulation' => [
                    ...
                    return [
                        ...
                        'children' => [
                            ...
                            [
                                'title' => 'Rangking',
                                'align' => 'right',
                                'dataIndex' => ['timeseries', $yearIndex, $categoryIndex, 'rank'],
                            ],
                        ],
                    ];
                }),
