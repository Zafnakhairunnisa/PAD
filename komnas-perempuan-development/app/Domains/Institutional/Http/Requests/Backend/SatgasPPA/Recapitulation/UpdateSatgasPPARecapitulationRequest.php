...
namespace App\Domains\Institutional\Http\Requests\Backend\SatgasPPA\Recapitulation;

use Illuminate\Foundation\Http\FormRequest;

/**
 * Class UpdateSatgasPPARecapitulationRequest.
 */
class UpdateSatgasPPARecapitulationRequest extends FormRequest
{
    /**
