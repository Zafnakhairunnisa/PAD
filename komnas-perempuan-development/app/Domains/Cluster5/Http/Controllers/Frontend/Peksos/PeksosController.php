...
namespace App\Domains\Cluster5\Http\Controllers\Frontend\Peksos;
...
class PeksosController
{
    ...
    /**
     * @var PeksosRecapitulationService
     */
    ...
    public function __construct(
        PeksosRecapitulationService $recapService,
        PeksosService $service
    ) {
        $this->service = $service;
        $this->recapService = $recapService;
        $this->categories = PeksosRecapitulationCategory::all();
    }
    ...
    {
        return inertia('Cluster5/Peksos', [
            'recapitulation' => [
    ...
    {
        $locations = $this->get_locations();
        $recapitulationCategories = PeksosRecapitulationCategory::all();
