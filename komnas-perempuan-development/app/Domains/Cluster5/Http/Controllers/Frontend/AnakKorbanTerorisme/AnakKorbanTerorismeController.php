...
namespace App\Domains\Cluster5\Http\Controllers\Frontend\AnakKorbanTerorisme;
...
/**
 * Class AnakKorbanTerorismeController.
 */
class AnakKorbanTerorismeController
{
    use LocationTrait;
    ...
    /**
     * @var AnakKorbanTerorismeRecapitulationService
     */
    private $service;
    ...
    public function __construct(
        AnakKorbanTerorismeRecapitulationService $service
    ) {
        $this->service = $service;
        $this->categories = AnakKorbanTerorismeRecapitulationCategory::all();
    }
    ...
    {
        return inertia('Cluster5/AnakKorbanTerorisme', [
            'recapitulation' => [
    ...
    {
        $locations = $this->get_locations();
        $recapitulationCategories = AnakKorbanTerorismeRecapitulationCategory::all();
