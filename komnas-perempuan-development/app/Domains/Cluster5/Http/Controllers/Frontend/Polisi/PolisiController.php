...
namespace App\Domains\Cluster5\Http\Controllers\Frontend\Polisi;
...
class PolisiController
{
    ...
    /**
     * @var PolisiDiyRecapitulationService
     */
    private $recapService;

    /**
     * @var PolisiDiyService
     */
    private $service;
    ...
    public function __construct(
        PolisiDiyRecapitulationService $recapService,
        PolisiDiyService $service
    ) {
        $this->service = $service;
        $this->recapService = $recapService;
        $this->categories = PolisiDiyRecapitulationCategory::all();
    }
    ...
    {
        return inertia('Cluster5/Polisi', [
            'recapitulation' => [
    ...
    private function generate_list_column()
    {
        $columns = [
            ...
            [
                'title' => 'Fasilitas Penyidikan Anak',
                'align' => 'center',
                'dataIndex' => 'fasilitas',
                'sorter' => true,
            ],
    ...
    {
        $locations = $this->get_locations();
        $recapitulationCategories = PolisiDiyRecapitulationCategory::all();
