...
namespace App\Domains\Cluster5\Http\Controllers\Frontend\AnakAids;
...
class AnakAidsController
{
    ...
    /**
     * @var AnakAidsRecapitulationService
     */
    private $service;
    ...
    public function __construct(
        AnakAidsRecapitulationService $service
    ) {
        $this->service = $service;
        $this->categories = AnakAidsRecapitulationCategory::all();
    }
    ...
    {
        return inertia('Cluster5/AnakAids', [
            'recapitulation' => [
    ...
    {
        $locations = $this->get_locations();
        $recapitulationCategories = AnakAidsRecapitulationCategory::all();
