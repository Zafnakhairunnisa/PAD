...
namespace App\Domains\Cluster5\Http\Controllers\Frontend\Kejaksaan;
...
class KejaksaanController
{
    ...
    /**
     * @var KejaksaanRecapitulationService
     */
    private $recapService;
    /**
     * @var KejaksaanService
     */
    private $service;
    ...
    public function __construct(
        KejaksaanRecapitulationService $recapService,
        KejaksaanService $service
    ) {
        $this->service = $service;
        $this->recapService = $recapService;
        $this->categories = KejaksaanRecapitulationCategory::all();
    }
    ...
    {
        return inertia('Cluster5/Kejaksaan', [
            'recapitulation' => [
    ...
    private function generate_list_column()
    {
        $columns = [
            ...
            [
                'title' => 'Fasilitas Pemeriksaan Anak',
                'align' => 'center',
                'dataIndex' => 'fasilitas',
                'sorter' => true,
            ],
    ...
    {
        $locations = $this->get_locations();
        $recapitulationCategories = KejaksaanRecapitulationCategory::all();
