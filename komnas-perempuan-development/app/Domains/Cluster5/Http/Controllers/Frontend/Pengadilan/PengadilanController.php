...
namespace App\Domains\Cluster5\Http\Controllers\Frontend\Pengadilan;
...
class PengadilanController
{
    ...
    public function __construct(
        PengadilanRecapitulationService $recapService,
        PengadilanService $service
    ) {
        $this->service = $service;
        $this->recapService = $recapService;
        $this->categories = PengadilanRecapitulationCategory::all();
    }
    ...
    {
        return inertia('Cluster5/Pengadilan', [
            'recapitulation' => [
    ...
    {
        $locations = $this->get_locations();
        $recapitulationCategories = PengadilanRecapitulationCategory::all();
