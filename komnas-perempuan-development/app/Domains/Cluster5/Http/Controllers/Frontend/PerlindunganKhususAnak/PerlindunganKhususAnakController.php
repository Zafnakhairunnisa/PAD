...
namespace App\Domains\Cluster5\Http\Controllers\Frontend\PerlindunganKhususAnak;
...
/**
 * Class PerlindunganKhususAnakController.
 */
class PerlindunganKhususAnakController
{
    use LocationTrait;
    ...
    /**
     * @var PerlindunganKhususAnakRecapitulationService
     */
    private $service;
    ...
    public function __construct(
        PerlindunganKhususAnakRecapitulationService $service
    ) {
        $this->service = $service;
        $this->categories = PerlindunganKhususAnakRecapitulationCategory::all();
    }
    ...
    {
        return inertia('Cluster5/PerlindunganKhususAnak', [
            'recapitulation' => [
    ...
    {
        $locations = $this->get_locations();
        $recapitulationCategories = PerlindunganKhususAnakRecapitulationCategory::all();
