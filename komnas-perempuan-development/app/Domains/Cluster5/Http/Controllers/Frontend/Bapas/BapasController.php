...
namespace App\Domains\Cluster5\Http\Controllers\Frontend\Bapas;
...
class BapasController
{
    ...
    /**
     * @var BapasRecapitulationService
     */
    ...
    public function __construct(
        BapasRecapitulationService $recapService,
        BapasService $service
    ) {
        $this->service = $service;
        $this->recapService = $recapService;
        $this->categories = BapasRecapitulationCategory::all();
    }
    ...
    {
        $locations = $this->get_locations();
        $recapitulationCategories = BapasRecapitulationCategory::all();
