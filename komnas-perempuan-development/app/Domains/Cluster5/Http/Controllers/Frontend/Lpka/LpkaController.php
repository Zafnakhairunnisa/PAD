...
namespace App\Domains\Cluster5\Http\Controllers\Frontend\Lpka;
...
class LpkaController
{
    ...
    public function __construct(
        LpkaRecapitulationService $recapService,
        LpkaService $service
    ) {
        $this->service = $service;
        $this->recapService = $recapService;
        $this->categories = LpkaRecapitulationCategory::all();
    }
    ...
    private function generate_list_column()
    {
        $columns = [
            ...
            [
                'title' => 'Jenis Ruangan Pembinaaan',
                'align' => 'center',
                'dataIndex' => 'jenis_ruangan',
                'sorter' => true,
            ],
            [
                'title' => 'Sarana Prasarana Darurat',
                'align' => 'center',
    ...
    {
        $locations = $this->get_locations();
        $recapitulationCategories = LpkaRecapitulationCategory::all();
