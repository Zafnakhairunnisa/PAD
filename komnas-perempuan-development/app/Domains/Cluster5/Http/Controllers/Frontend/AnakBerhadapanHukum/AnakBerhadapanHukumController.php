...
namespace App\Domains\Cluster5\Http\Controllers\Frontend\AnakBerhadapanHukum;
...
/**
 * Class AnakBerhadapanHukumController.
 */
class AnakBerhadapanHukumController
{
    use LocationTrait;
    ...
    /**
     * @var AnakBerhadapanHukumRecapitulationService
     */
    private $service;
    ...
    public function __construct(
        AnakBerhadapanHukumRecapitulationService $service
    ) {
        $this->service = $service;
        $this->categories = AnakBerhadapanHukumRecapitulationCategory::all();
    }
    ...
    {
        return inertia('Cluster5/AnakBerhadapanHukum', [
            'recapitulation' => [
    ...
    {
        $locations = $this->get_locations();
        $recapitulationCategories = AnakBerhadapanHukumRecapitulationCategory::all();
