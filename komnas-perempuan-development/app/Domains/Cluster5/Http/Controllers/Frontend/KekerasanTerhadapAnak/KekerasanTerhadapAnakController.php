...
namespace App\Domains\Cluster5\Http\Controllers\Frontend\KekerasanTerhadapAnak;
...
/**
 * Class KekerasanTerhadapAnakController.
 */
class KekerasanTerhadapAnakController
{
    use LocationTrait;
    ...
    /**
     * @var KekerasanTerhadapAnakRecapitulationService
     */
    private $service;
    ...
    public function __construct(
        KekerasanTerhadapAnakRecapitulationService $service
    ) {
        $this->service = $service;
        $this->categories = KekerasanTerhadapAnakRecapitulationCategory::all();
    }
    ...
    {
        return inertia('Cluster5/KekerasanTerhadapAnak', [
            'recapitulation' => [
    ...
    {
        $locations = $this->get_locations();
        $recapitulationCategories = KekerasanTerhadapAnakRecapitulationCategory::all();
