...
namespace App\Domains\Cluster5\Imports\AnakKorbanTerorisme;
...
class AnakKorbanTerorismeImport implements ToCollection, WithStartRow, WithChunkReading, WithValidation, WithBatchInserts
{
    use Importable;

    public function collection(Collection $rows)
    {
        $category = AnakKorbanTerorismeRecapitulationCategory::select('id','name')->get()->toArray();
        ...
        AnakKorbanTerorismeRecapitulation::insert($data);
    }
