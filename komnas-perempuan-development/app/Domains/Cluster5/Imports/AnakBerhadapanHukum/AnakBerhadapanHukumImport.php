...
namespace App\Domains\Cluster5\Imports\AnakBerhadapanHukum;
...
class AnakBerhadapanHukumImport implements ToCollection, WithStartRow, WithChunkReading, WithValidation, WithBatchInserts
{
    use Importable;

    public function collection(Collection $rows)
    {   
        $category = AnakBerhadapanHukumRecapitulationCategory::select('id','name')->get()->toArray();
        ...
        AnakBerhadapanHukumRecapitulation::insert($data);
    }
