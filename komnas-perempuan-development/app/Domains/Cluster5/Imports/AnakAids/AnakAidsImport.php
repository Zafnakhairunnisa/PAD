...
namespace App\Domains\Cluster5\Imports\AnakAids;
...
class AnakAidsImport implements ToCollection, WithStartRow, WithChunkReading, WithValidation, WithBatchInserts
{
    use Importable;

    public function collection(Collection $rows)
    {
        $category = AnakAidsRecapitulationCategory::select('id','name')->get()->toArray();
        ...
        AnakAidsRecapitulation::insert($data);
    }
