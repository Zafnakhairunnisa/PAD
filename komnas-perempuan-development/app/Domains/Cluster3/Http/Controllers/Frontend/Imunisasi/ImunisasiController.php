...
namespace App\Domains\Cluster3\Http\Controllers\Frontend\Imunisasi;
...
class ImunisasiController
{
    ...
    /**
     * @var ImmunizationRecapitulationService
     */
    private $service;
    ...
    {
        return inertia('Cluster3/Imunisasi', [
            'recapitulation' => [
    ...
    {
        $locations = $this->get_locations();
        $recapitulationCategories = collect(['Imunisasi']);
