...
namespace App\Domains\Cluster3\Http\Controllers\Frontend\PemberianAirSusuIbu;
...
/**
 * Class PemberianAirSusuIbuController.
 */
class PemberianAirSusuIbuController
{
    use LocationTrait;
    ...
    /**
     * @var BreastFeedingService
     */
    private $service;

    /**
     * @var BreastFeedingRecapitulationService
     */
    ...
    public function __construct(
        ...
        $this->categories = BreastFeedingRecapitulationCategory::select('id', 'name')->get();
    }
    ...
    {
        return inertia('Cluster3/PemberianAirSusuIbu', [
            'recapitulation' => [
