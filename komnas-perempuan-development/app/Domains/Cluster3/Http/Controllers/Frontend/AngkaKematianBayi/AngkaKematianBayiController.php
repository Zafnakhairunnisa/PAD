...
namespace App\Domains\Cluster3\Http\Controllers\Frontend\AngkaKematianBayi;
...
/**
 * Class AngkaKematianBayiController.
 */
class AngkaKematianBayiController
{
    use LocationTrait;
    ...
    /**
     * @var InfantMortalityRecapitulationService
     */
    private $service;
    ...
    {
        return inertia('Cluster3/AngkaKematianBayi', [
            'recapitulation' => [
    ...
    {
        $locations = $this->get_locations();
        $recapitulationCategories = collect(['Kematian Bayi']);
