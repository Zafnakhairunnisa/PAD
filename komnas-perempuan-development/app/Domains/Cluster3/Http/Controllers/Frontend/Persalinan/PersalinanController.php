...
namespace App\Domains\Cluster3\Http\Controllers\Frontend\Persalinan;
...
class PersalinanController
{
    ...
    /**
     * @var ChildBirthRecapitulationService
     */
    private $service;
    ...
    {
        return inertia('Cluster3/Persalinan', [
            'recapitulation' => [
