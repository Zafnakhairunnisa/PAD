...
namespace App\Domains\Cluster3\Http\Controllers\Frontend\AngkaKematianIbuMelahirkan;
...
/**
 * Class AngkaKematianIbuMelahirkanController.
 */
class AngkaKematianIbuMelahirkanController
{
    use LocationTrait;
    ...
    /**
     * @var MaternalDeathRecapitulationService
     */
    private $service;
    ...
    {
        return inertia('Cluster3/AngkaKematianIbuMelahirkan', [
            'recapitulation' => [
