...
namespace App\Domains\Cluster3\Http\Controllers\Frontend\KartuIbuAnak;
...
class KartuIbuAnakController
{
    ...
    /**
     * @var MotherAndDaughterCardRecapitulationService
     */
    private $service;
    ...
    {
        return inertia('Cluster3/KartuIbuAnak', [
            'recapitulation' => [
