...
use App\Domains\Institutional\Exports\Kapanewon\KapanewonTemplateExport;
use App\Domains\Institutional\Imports\Kapanewon\KapanewonImport;
use Excel;
use Illuminate\Support\Facades\Bus;
use Livewire\Component;
use Livewire\WithFileUploads;

class KapanewonImportForm extends Component
{
    use WithFileUploads;
    ...
    public function download()
    {
        return Excel::download(
            new KapanewonTemplateExport,
            __('Template Import Kapanewon').'.xlsx'
        );
    }
    ...
    public function submit()
    {
        try {
            ...
            Excel::import(new KapanewonImport, $this->importFilePath, 'local');
    ...
    {
        return view('backend.institutional.kapanewon.import')
