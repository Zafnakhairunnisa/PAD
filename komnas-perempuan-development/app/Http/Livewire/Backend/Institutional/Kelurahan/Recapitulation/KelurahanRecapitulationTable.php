...
/**
 * Class KelurahanRecapitulationTable.
 */
class KelurahanRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi Kelurahan';
    ...
    public function boot()
    {
        ...
        $this->categories = KelurahanRecapitulationCategory::select('id', 'name')
            ->get()
    ...
    {
        return KelurahanRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.institutional.kelurahan.recapitulation.includes.row';
    }
