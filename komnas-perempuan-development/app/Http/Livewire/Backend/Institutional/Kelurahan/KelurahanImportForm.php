...
use App\Domains\Institutional\Exports\Kelurahan\KelurahanTemplateExport;
use App\Domains\Institutional\Imports\Kelurahan\KelurahanImport;
use Excel;
use Illuminate\Support\Facades\Bus;
use Livewire\Component;
use Livewire\WithFileUploads;

class KelurahanImportForm extends Component
{
    use WithFileUploads;
    ...
    public function download()
    {
        return Excel::download(
            new KelurahanTemplateExport,
            __('Template Import Kelurahan').'.xlsx'
        );
    }
    ...
    public function submit()
    {
        try {
            ...
            Excel::import(new KelurahanImport, $this->importFilePath, 'local');
    ...
    {
        return view('backend.institutional.kelurahan.import')
