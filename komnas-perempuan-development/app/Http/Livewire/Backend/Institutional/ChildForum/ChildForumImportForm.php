...
use App\Domains\Institutional\Exports\ChildForum\ChildForumTemplateExport;
use App\Domains\Institutional\Imports\ChildForum\ChildForumImport;
use Excel;
use Livewire\Component;
use Livewire\WithFileUploads;

class ChildForumImportForm extends Component
{
    use WithFileUploads;
    ...
    {
        return Excel::download(new ChildForumTemplateExport, __('Template Impor Forum Anak').'.xlsx');
    }
    ...
    public function submit()
    {
        try {
            ...
            Excel::import(new ChildForumImport, $this->importFilePath, 'local');
    ...
    {
        return view('backend.institutional.child_forum.import')
