...
/**
 * Class PaudHiRecapitulationTable.
 */
class PaudHiRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi paud hi';
    ...
    public function boot()
    {
        ...
        $this->categories = PaudHiCategory::get()
            ->mapWithKeys(function ($query) {
                return [$query->id => $query->name];
            })
    ...
    {
        return PaudHiRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_2.paud_hi.recapitulation.includes.row';
    }
