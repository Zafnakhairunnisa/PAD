...
/**
 * Class PerkawinanAnakTable.
 */
class PerkawinanAnakTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data perkawinan anak';
    ...
    {
        return PerkawinanAnak::with('location:id,name')
    ...
    {
        return 'backend.cluster_2.perkawinan_anak.includes.row';
    }
