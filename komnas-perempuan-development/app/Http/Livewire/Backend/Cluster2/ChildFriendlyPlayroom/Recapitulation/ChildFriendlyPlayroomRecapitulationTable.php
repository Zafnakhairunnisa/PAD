...
/**
 * Class ChildFriendlyPlayroomRecapitulationTable.
 */
class ChildFriendlyPlayroomRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi ruang bermain ramah anak';
    ...
    public function boot()
    {
        ...
        $this->categories = ChildFriendlyPlayroomCategory::get()->mapWithKeys(function ($query) {
            return [$query->id => $query->name];
        })
    ...
    {
        return ChildFriendlyPlayroomRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_2.child_friendly_playroom.recapitulation.includes.row';
    }
