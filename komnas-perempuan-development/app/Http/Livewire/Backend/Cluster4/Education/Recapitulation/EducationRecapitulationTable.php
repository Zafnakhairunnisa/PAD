...
/**
 * Class EducationRecapitulationTable.
 */
class EducationRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi pendidikan';
    ...
    public function boot()
    {
        ...
        $this->categories = EducationRecapitulationCategory::select('id', 'name')
            ->get()
    ...
    {
        return EducationRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_4.education.recapitulation.includes.row';
    }
