...
/**
 * Class RumahIbadahRamahAnakRecapitulationTable.
 */
class RumahIbadahRamahAnakRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi rumah ibadah ramah anak';
    ...
    public function boot()
    {
        ...
        $this->categories = RumahIbadahRamahAnakRecapitulationCategory::select('id', 'name')
            ->get()
    ...
    {
        return RumahIbadahRamahAnakRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_4.rumah_ibadah_ramah_anak.recapitulation.includes.row';
    }
