...
/**
 * Class PeksosRecapitulationTable.
 */
class PeksosRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi Pekerja Sosial';
    ...
    public function boot()
    {
        ...
        $this->categories = PeksosRecapitulationCategory::select('id', 'name')
            ->get()
    ...
    {
        return PeksosRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_5.peksos.recapitulation.includes.row';
    }
