...
use App\Domains\Cluster5\Exports\Peksos\PeksosTemplateExport;
use App\Domains\Cluster5\Imports\Peksos\PeksosImport;
use Excel;
use Illuminate\Support\Facades\Bus;
use Livewire\Component;
use Livewire\WithFileUploads;

class PeksosImportForm extends Component
{
    use WithFileUploads;
    ...
    public function download()
    {
        return Excel::download(
            new PeksosTemplateExport,
            __('Template Import Pekerja Sosial').'.xlsx'
        );
    }
    ...
    public function submit()
    {
        try {
            ...
            Excel::import(new PeksosImport, $this->importFilePath, 'local');
    ...
    {
        return view('backend.cluster_5.peksos.import')
