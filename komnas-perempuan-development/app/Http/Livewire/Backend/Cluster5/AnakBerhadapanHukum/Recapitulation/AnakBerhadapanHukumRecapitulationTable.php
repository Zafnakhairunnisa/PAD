...
/**
 * Class AnakBerhadapanHukumRecapitulationTable.
 */
class AnakBerhadapanHukumRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi anak berhadapan dengan hukum';
    ...
    public function boot()
    {
        ...
        $this->categories = AnakBerhadapanHukumRecapitulationCategory::select('id', 'name')
            ->get()
    ...
    {
        return AnakBerhadapanHukumRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_5.anak_berhadapan_hukum.recapitulation.includes.row';
    }
