...
/**
 * Class BapasRecapitulationTable.
 */
class BapasRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi Balai Pemasyarakatan';
    ...
    public function boot()
    {
        ...
        $this->categories = BapasRecapitulationCategory::select('id', 'name')
            ->get()
    ...
    {
        return BapasRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_5.bapas.recapitulation.includes.row';
    }
