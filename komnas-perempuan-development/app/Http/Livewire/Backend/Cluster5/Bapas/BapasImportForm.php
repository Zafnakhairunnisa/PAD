...
use App\Domains\Cluster5\Exports\Bapas\BapasTemplateExport;
use App\Domains\Cluster5\Imports\Bapas\BapasImport;
use Excel;
use Illuminate\Support\Facades\Bus;
use Livewire\Component;
use Livewire\WithFileUploads;

class BapasImportForm extends Component
{
    use WithFileUploads;
    ...
    public function download()
    {
        return Excel::download(
            new BapasTemplateExport,
            __('Template Import Balai Pemasyarakatan').'.xlsx'
        );
    }
    ...
    public function submit()
    {
        try {
            ...
            Excel::import(new BapasImport, $this->importFilePath, 'local');
    ...
    {
        return view('backend.cluster_5.bapas.import')
