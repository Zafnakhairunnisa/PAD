...
/**
 * Class PatbmRecapitulationTable.
 */
class PatbmRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi Lembaga Pembinaan Khusus Anak Yogyakarta';
    ...
    public function boot()
    {
        ...
        $this->categories = PatbmRecapitulationCategory::select('id', 'name')
            ->get()
    ...
    {
        return PatbmRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_5.patbm.recapitulation.includes.row';
    }
