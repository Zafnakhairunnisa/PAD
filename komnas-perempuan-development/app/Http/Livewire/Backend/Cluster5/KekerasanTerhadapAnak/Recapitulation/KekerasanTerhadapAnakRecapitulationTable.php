...
/**
 * Class KekerasanTerhadapAnakRecapitulationTable.
 */
class KekerasanTerhadapAnakRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi Kekerasan Terhadap Anak';
    ...
    public function boot()
    {
        ...
        $this->categories = KekerasanTerhadapAnakRecapitulationCategory::select('id', 'name')
            ->get()
    ...
    {
        return KekerasanTerhadapAnakRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_5.kekerasan_terhadap_anak.recapitulation.includes.row';
    }
