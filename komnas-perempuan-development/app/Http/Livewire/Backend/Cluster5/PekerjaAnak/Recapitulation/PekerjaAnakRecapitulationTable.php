...
/**
 * Class PekerjaAnakRecapitulationTable.
 */
class PekerjaAnakRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi pekerja anak';
    ...
    {
        return PekerjaAnakRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_5.pekerja_anak.recapitulation.includes.row';
    }
