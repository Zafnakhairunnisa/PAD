...
/**
 * Class BprsRecapitulationTable.
 */
class BprsRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi balai perlindungan dan rehabilitasi sosial remaja (BPRSR) DIY';
    ...
    public function boot()
    {
        ...
        $this->categories = BprsRecapitulationCategory::select('id', 'name')
            ->get()
    ...
    {
        return BprsRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_5.bprs.recapitulation.includes.row';
    }
