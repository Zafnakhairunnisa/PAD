...
/**
 * Class AnakAidsRecapitulationTable.
 */
class AnakAidsRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi anak aids';
    ...
    public function boot()
    {
        ...
        $this->categories = AnakAidsRecapitulationCategory::select('id', 'name')
            ->get()
    ...
    {
        return AnakAidsRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_5.anak_aids.recapitulation.includes.row';
    }
