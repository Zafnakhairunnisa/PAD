...
/**
 * Class LpkaRecapitulationTable.
 */
class LpkaRecapitulationTable extends DataTableComponent
{
    ...
    public function boot()
    {
        ...
        $this->categories = LpkaRecapitulationCategory::select('id', 'name')
            ->get()
    ...
    {
        return LpkaRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_5.lpka.recapitulation.includes.row';
    }
