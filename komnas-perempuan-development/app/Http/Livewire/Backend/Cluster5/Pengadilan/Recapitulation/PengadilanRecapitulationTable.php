...
/**
 * Class PengadilanRecapitulationTable.
 */
class PengadilanRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi Pengadilan DIY';
    ...
    public function boot()
    {
        ...
        $this->categories = PengadilanRecapitulationCategory::select('id', 'name')
            ->get()
    ...
    {
        return PengadilanRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_5.pengadilan.recapitulation.includes.row';
    }
