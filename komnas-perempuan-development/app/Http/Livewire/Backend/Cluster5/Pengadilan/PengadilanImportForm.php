...
use App\Domains\Cluster5\Exports\Pengadilan\PengadilanTemplateExport;
use App\Domains\Cluster5\Imports\Pengadilan\PengadilanImport;
use Excel;
use Illuminate\Support\Facades\Bus;
use Livewire\Component;
use Livewire\WithFileUploads;

class PengadilanImportForm extends Component
{
    use WithFileUploads;
    ...
    public function download()
    {
        return Excel::download(
            new PengadilanTemplateExport,
            __('Template Import Pengadilan').'.xlsx'
        );
    }
    ...
    public function submit()
    {
        try {
            ...
            Excel::import(new PengadilanImport, $this->importFilePath, 'local');
    ...
    {
        return view('backend.cluster_5.pengadilan.import')
