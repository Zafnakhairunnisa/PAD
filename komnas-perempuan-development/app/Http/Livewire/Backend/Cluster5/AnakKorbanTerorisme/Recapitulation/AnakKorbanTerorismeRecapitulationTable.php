...
/**
 * Class AnakKorbanTerorismeRecapitulationTable.
 */
class AnakKorbanTerorismeRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi anak korban terorisme dan radikalisme';
    ...
    public function boot()
    {
        ...
        $this->categories = AnakKorbanTerorismeRecapitulationCategory::select('id', 'name')
            ->get()
    ...
    {
        return AnakKorbanTerorismeRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_5.anak_korban_terorisme.recapitulation.includes.row';
    }
