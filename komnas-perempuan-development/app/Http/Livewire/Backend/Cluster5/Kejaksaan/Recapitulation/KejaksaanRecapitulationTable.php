...
/**
 * Class KejaksaanRecapitulationTable.
 */
class KejaksaanRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi Kejaksaan Daerah DIY';
    ...
    public function boot()
    {
        ...
        $this->categories = KejaksaanRecapitulationCategory::select('id', 'name')
            ->get()
    ...
    {
        return KejaksaanRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_5.kejaksaan.recapitulation.includes.row';
    }
