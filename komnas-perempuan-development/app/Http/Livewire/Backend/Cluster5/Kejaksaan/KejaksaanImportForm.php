...
use App\Domains\Cluster5\Exports\Kejaksaan\KejaksaanTemplateExport;
use App\Domains\Cluster5\Imports\Kejaksaan\KejaksaanImport;
use Excel;
use Illuminate\Support\Facades\Bus;
use Livewire\Component;
use Livewire\WithFileUploads;

class KejaksaanImportForm extends Component
{
    use WithFileUploads;
    ...
    public function download()
    {
        return Excel::download(
            new KejaksaanTemplateExport,
            __('Template Import Kejaksaan').'.xlsx'
        );
    }
    ...
    public function submit()
    {
        try {
            ...
            Excel::import(new KejaksaanImport, $this->importFilePath, 'local');
    ...
    {
        return view('backend.cluster_5.kejaksaan.import')
