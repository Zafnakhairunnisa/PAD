...
/**
 * Class InfantMortalityRecapitulationTable.
 */
class InfantMortalityRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi angka kematian bayi';
    ...
    {
        return InfantMortalityRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_3.infant_mortality.recapitulation.includes.row';
    }
