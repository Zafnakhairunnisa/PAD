...
/**
 * Class MaternalDeathRecapitulationTable.
 */
class MaternalDeathRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi kematian ibu melahirkan';
    ...
    {
        return MaternalDeathRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_3.maternal_death.recapitulation.includes.row';
    }
