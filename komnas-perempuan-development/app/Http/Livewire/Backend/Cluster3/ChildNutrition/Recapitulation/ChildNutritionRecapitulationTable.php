...
/**
 * Class ChildNutritionRecapitulationTable.
 */
class ChildNutritionRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi status gizi anak';
    ...
    public function boot()
    {
        ...
        $this->categories = ChildNutritionRecapitulationCategory::select('id', 'name')
            ->get()
    ...
    {
        return ChildNutritionRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_3.child_nutrition.recapitulation.includes.row';
    }
