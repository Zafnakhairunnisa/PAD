...
/**
 * Class MotherAndDaughterCardRecapitulationTable.
 */
class MotherAndDaughterCardRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi kartu ibu dan anak';
    ...
    {
        return MotherAndDaughterCardRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_3.mother_and_daughter_card.recapitulation.includes.row';
    }
