...
/**
 * Class BreastFeedingRecapitulationTable.
 */
class BreastFeedingRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi pemberian air susu ibu';
    ...
    public function boot()
    {
        ...
        $this->categories = BreastFeedingRecapitulationCategory::select('id', 'name')
            ->get()
    ...
    {
        return BreastFeedingRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_3.breast_feeding.recapitulation.includes.row';
    }
