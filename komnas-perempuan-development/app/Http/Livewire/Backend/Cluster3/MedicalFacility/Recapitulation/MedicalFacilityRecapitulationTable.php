...
/**
 * Class MedicalFacilityRecapitulationTable.
 */
class MedicalFacilityRecapitulationTable extends DataTableComponent
{
    public string $defaultSortColumn = 'created_at';

    public string $defaultSortDirection = 'desc';

    public string $emptyMessage = 'Tidak ada data rekapitulasi fasilitas kesehatan ramah anak';
    ...
    public function boot()
    {
        ...
        $this->categories = MedicalFacilityRecapitulationCategory::select('id', 'name')
            ->get()
    ...
    {
        return MedicalFacilityRecapitulation::with('location:id,name')
    ...
    {
        return 'backend.cluster_3.medical_facility.recapitulation.includes.row';
    }
